<div class="font-wight-bold text-center pb-3 pt-3" style="font-size: 24px">
    {{$item->name}}
</div>

<div class="row">
    <div class="col-4 offset-1">
        <img src="/storage/item-images/{{ $item->image_file_name }}" alt="" class="card-img-top">
    </div>
    <div class="col-6">
            ...
            <tr>
                ...
                <td>
                    @if (!empty($item->seller->avatar_file_name))
                        <img src="/storage/avatars/{{ $item->seller->avatar_file_name }}" alt="" class="rounded-circle"
