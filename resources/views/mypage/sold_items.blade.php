            ...
            <div class="col-10 offset-1 bg-white">
                ...
                @foreach ($items as $item)
                    <div class="d-flex mt-3 border position-relative">
                        <div>
                            <img src="/storage/item-images/{{ $item->image_file_name }}" alt="" class="img-fluid" style="height: 140px;">
                        </div>
                        <div class="flex-fill p-3">
                            ...
                            <div class="card-title mt-2 font-weight-bold" style="font-size: 20px">
                                {{ $item->name }}
                            </div>
                            <div>
